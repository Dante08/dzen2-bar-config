...
wifiState=$(cat /sys/class/net/wlan0/operstate)
ethernetState=$(cat /sys/class/net/eth0/operstate)
...
) | dzen2 -p -x 750 -y 660 -w 235 -bg $BG -fg $FG -l 3 -sa l -ta c -e 'onstart=uncollapse;button1=exit;button3=exit' -fn $fn1
